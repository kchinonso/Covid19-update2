<?php
$title = "Latest UK and Word Covid Data";
require "header.php";
         ...
         <div class="row">
             ...
             <div class="card shadow boder">
                        ...
                        <div class="card-body row justify-content-center ">
                           ...
                           <img src="asset/images/uk-data.png" height="50" class="card-img-top w-25" alt="">
       ...
       <div class="col-md-6 mt-5">
         <div class="card shadow boder">
             ...
             <div class="col-md-6 mt-2">
              <div class="card shadow boder bg-primary">
                         
                         <div class="card-body  ">
      
                            
                            <h3 class="card-title text-center text-white">UK Data</h3>
                          <p class="card-text">
