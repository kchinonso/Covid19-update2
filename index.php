      ...
      <div class="container ">
       ...
       <div class="col-md-10">
          ...
          <div class="col-md-4 mt-5">
           ...
           <div class="col-md-4 mt-5">
            <a href="positive_covid.php"> <div class="card shadow boder bg-primary radius" >
             ...
             <div class="card-body justify-content-center row">
               <img src="asset/images/tested-positive.png"  height="100" class="card-img-top w-100 " alt="">
        ...
        <div class="card shadow boder h-100">
                        ...
                        <div class="card-body">
                           <h3 class="card-title text-center">Under 18</h3>
                           ...
                           <ul>
                               <li>
                                Try to stay at Home for 3 Days after the Day of Test
                               </li>
                           </ul>
                        </p>
